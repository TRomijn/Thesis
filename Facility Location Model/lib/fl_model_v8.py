...
def FL_model(
    ...
    if graphical_representation == True:
        return total_costs, nr_uncovered_DPs, total_uncovered_demand, max_distr_time, all_op_fls_in_use, map_1
    else:
        return total_costs, nr_uncovered_DPs, total_uncovered_demand, max_distr_time, all_op_fls_in_use, None
