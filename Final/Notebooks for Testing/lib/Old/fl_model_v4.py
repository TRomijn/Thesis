...
def create_distance_matrix(
        all_nodes, dist_method, distance_to_self=999
...
def FL_model(
    ...
    disr_roads = create_disrupted_road_matrix(distances, disruption_FLs,
                                              facility_locations)
    # calculate road disruptions for DPs
    disr_roads = create_disrupted_road_matrix(distances, disruption_DPs,
                                              demand_points)
    ...
    total_costs = calc_costs(supply_points, facility_locations, demand_points,
                             ...
                             FL_operations_cost, distances, allocation_matrix)
